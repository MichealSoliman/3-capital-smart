...
export const metadata: Metadata = {
  ...
  description: 'شركة 3Capital للاستشارات المالية والأعمال - خبراء في التمويل والاستثمار والاستشارات المالية. نقدم حلولاً استشارية متكاملة مع خبرة تزيد عن 17 عاماً',
  keywords: [
    'استشارات مالية',
    'استشارات أعمال',
    'تمويل',
